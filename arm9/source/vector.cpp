...
fw32 VecF32::mag(const VecF32& vec) { return fw32::sqrtfw32(mag2(vec)); }
...
VecF32 VecF32::floor() {
	return VecF32(fw32::floorfw32(x), fw32::floorfw32(y), fw32::floorfw32(z));
}

void VecF32::applyFloor() { *this = floor(); }

VecF32 VecF32::ceil() { return VecF32(fw32::ceilfw32(x), fw32::ceilfw32(y), fw32::ceilfw32(z)); }
